...
<html>
    ...
    <body>
        ...
        try
        {
            ...
            int i=st.executeUpdate("INSERT INTO pgowner_registration(Uname, Email, Password, Confirm_password,Mobile) values('"+Uname+"','"+Email+"','"+Password+"','"+Confirm_Password+"','"+Mobile+"')");
